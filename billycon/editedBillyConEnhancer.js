...
// @include        http*://*animecubed*.com/billy/bvs/billycon*
// @namespace      North
...
function BillyCon() {
  ...
  var events = {
    ...
    "Work a Booth": [
      6,
      "-4 Nom, -4 Sleep, +2 Stink",
      "Staring 1+, Staring 2+, Staring 4+, Stink <-2, Sleep 6+",
      "Stink 3+, Staring <1",
      "0: -1 Cool / +3 Monies<br/>1: +4 Monies / +20 Staring XP<br/>2: +6 Monies / +30 Staring XP<br/>4+: +8 Monies / +30 Veteran XP / 1 11% Chance for a Manly Apron Award",
    ],

    // Video 1
    9001: [
      5,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Stink <4, Cool 4+, Videogaming 2+, Chillaxing 1+, Veteran 1+",
      "Stink 4+, Cool <1",
      "0: +10 Flipping Out XP<br/>1: +25 Flipping Out XP<br/>2: +30 Flipping Out XP / +1 Cool<br/>3+: +50 Flipping Out XP / +1 Cool",
    ],
    "Bishounen and Bunny DX": [
      5,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Stink <1, Cool 1+, Cool 6+, Chillaxing 1+, Knowledge 1+",
      "Stink 4+, Cool <1",
      "0: +10 Cosplay XP<br/>1: +25 Cosplay XP<br/>2: +30 Cosplay XP / +1 Cool / +1 Pet Point<br/>3+: +30 Wrangling XP / +1 Cool / +1 Pet Point",
    ],
    ...
    "Game Defeater Yuri": [
      6,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Stink <2, Cool 4+, Videogaming 1+, Knowledge 1+, Videogaming 2+",
      "Stink 4+, Cool <1",
      "0: +10 Videogaming XP<br/>1: +25 Videogaming XP<br/>2: +30 Videogaming XP / +1 Cool<br/>3+: +50 Videogaming XP / +1 Cool",
    ],
    "Grind Warriors": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Cool 1+, Cool 4+, Videogaming 1+, Silence 1+, Chillaxing 1+",
      "Stink 4+, Cool <1",
      "0: +1 Cool<br/>1: +2 Cool / +25 Chillaxing XP<br/>2: +30 GeoSense XP / +3 Cool<br/>3+: +50 Knowledge XP / +4 cool",
    ],
    ...
    "No Such Thing As Boys": [
      5,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Stink <1, Chillaxing 1+, Knowledge 2+, Chillaxing 1+, Silence 1+",
      "Stink 4+, Cool <0",
      "0: +10 Chillaxing XP<br/>1: +25 Chillaxing XP<br/>2: +30 Chillaxing XP / +1 Cool<br/>3+: +50 Chillaxing XP / +1 Cool",
    ],
    PizzaWatch: [
      5,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Cool 1+, Cool 4+, Videogaming 1+, Crowdswimming 1+, Knowledge 1+",
      "Stink 4+, Cool <1",
      "0: +10 Videogaming XP<br/>1: +25 Videogaming XP<br/>2: +30 Crowdswimming XP / +1 Cool<br/>3+: +50 Crowdswimming XP / +1 Cool",
    ],
    "Pop Idol Werewolf": [
      7,
      "-1 Nom, -1 Sleep",
      "Stink <2, Cool 2+, Dance 1+, Wrangling 1+, Cosplay 2+",
      "Stink 4+, Cool <1",
      "0: +10 Dance XP<br/>1: +25 Dance XP<br/>2: +30 Dance XP / +1 Cool / +1 Pet Point<br/>3+: +50 Schmoozing XP / +1 Pet Point / +2 Cool",
    ],
    "Reaper Cooking Parade": [
      7,
      "-1 Nom, -2 Sleep, +1 Stink",
      "Stink <1, Cool 1+, Combat Sewing 1+, Drama 1+, Videogaming 1+",
      "Stink 4+, Cool <1",
      "0: +10 Artsiness XP<br/>1: +25 Artsiness XP<br/>2: +30 Artsiness XP / +1 Cool<br/>3+: +50 Artsiness XP / +1 Cool",
    ],
    ...
    "Speed Rider XD6": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Cool 3+, Cool 6+, Videogaming 2+, Crowdswimming 1+, Knowledge 2+",
      "Stink 4+, Cool <1",
      "0: +1 Cool<br/>1: +1 Cool / +25 Videogaming XP<br/>2: +40 Videogaming XP / +3 Cool<br/>3+: +50 GeoSense XP / +4 Cool",
    ],
    ...
    "Who Wears That to School?": [
      5,
      "-1 Nom, -1 Sleep",
      "Cool 2+, Photography 1+, Cosplay 1+, Cosplay 2+, Combat Sewing 1+",
      "Stink 4+, Cool <1",
      "0: +10 Cosplay XP<br/>1: +25 Cosplay XP<br/>2: +30 Cosplay XP / +1 Cool<br/>3+: +50 Combat Sewing XP / +1 Cool",
    ],
    // All night events
    ...
    "11DBHK Meetup": [
      5,
      "-1 Nom",
      "Stink <-2, Chillaxing 1+, Cool 6+, Knowledge 1+, Veteran 1+",
      "Stink 4+, Cool <1",
      "0: +10 Chillaxing XP<br/>1: +20 Chillaxing XP<br/>2: +30 Chillaxing XP<br/>3: +30 Chillaxing XP / +30 Knowledge XP<br/>4+: +30 Chillaxing XP / +50 Knowledge XP / 1 11% Chance for a BillyCon Emblem Award",
    ],
    "Being the Center of Attention": [
      5,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Stink <-1, Macking 1+, Cool 6+, Posing 1+, Drama 4+",
      "Stink 4+, Cool <1",
      "0: +5 Drama XP<br/>1: +10 Drama XP<br/>2: +20 Drama XP / +2 Cool<br/>3: +40 Drama XP / +3 Cool<br/>4+: +40 Posing XP / +4 Cool",
    ],
    "Bingo Practice": [
      6,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Sleep 5+, Cool 4+, Knowledge 4+, Silence 2+, Cosplay 2+",
      "Stink 4+, Cool <1",
      "0: +5 GeoSense XP<br/>1: +10 GeoSense XP<br/>2: +20 GeoSense XP / +2 Cool<br/>3: +30 GeoSense XP / +3 Cool<br/>4+: +40 Glowsticking XP",
    ],
    "Books to Eat": [
      5,
      "-1 Nom, -1 Sleep, +2 Stink",
      "Stink <1, Sleep 3+, Nom 5+, Shopping 1+, Knowledge 2+",
      "Stink 4+, Cool <1",
      "0: +10 Knowledge XP<br/>1: +20 Knowledge XP<br/>2: +30 Knowledge XP<br/>3: +40 Knowledge XP / +3 Nom<br/>4+: +40 Knowledge XP / +5 Nom",
    ],
    "Books to Read": [
      6,
      "-2 Nom, -2 Sleep, +2 Stink",
      "Stink <1, Sleep 5+, Nom 2+, Silence 1+, Knowledge 2+",
      "Stink 4+, Cool <1",
      "0: +10 Knowledge XP<br/>1: +20 Knowledge XP<br/>2: +30 Knowledge XP<br/>3: +40 Knowledge XP / +20 Artsiness XP<br/>4+: +40 Knowledge XP / +40 Artsiness XP",
    ],
    "Button Mashing": [
      6,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Videogaming 2+, Videogaming 4+, Cool 2+, Knowledge 1+, Veteran 1+",
      "Stink 4+, Cool <1",
      "0: +5 Videogaming XP<br/>1: +10 Videogaming XP<br/>2: +20 Videogaming XP<br/>3: +30 Videogaming XP<br/>4+: +40 Videogaming XP / +5 Monies",
    ],
    "Coming Up With Panel Names": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Nom 4+, Knowledge 1+, Knowledge 3+, Chillaxing 1+, Sleep 4+",
      "Stink 4+, Cool <1",
      "0: +10 Knowledge XP<br/>1: +20 Artsiness XP<br/>2: +30 Artsiness XP<br/>3: +30 Artsiness XP / +2 Cool<br/>4+: +30 Artsiness XP / +30 Veteran XP",
    ],
    "EZ Ramen": [
      6,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Stink <4, Chillaxing 1+, Cool 1+, Sleep 2+, Nom 2+",
      "Stink 4+, Cool <1",
      "0: +5 Chillaxing XP<br/>1: +10 Chillaxing XP<br/>2: +20 Chillaxing XP / +2 Nom<br/>3: +40 Chillaxing XP / +3 Nom<br/>4+: +40 Chillaxing XP / +4 Nom",
    ],
    "Finding Free Time": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Cool 4+, Chillaxing 1+, Chillaxing 3+, Stink <1, Antidrama 1+",
      "Stink 4+, Cool <1",
      "0: +5 Chillaxing XP<br/>1: +10 Chillaxing XP<br/>2: +20 Chillaxing XP<br/>3: +40 Chillaxing XP<br/>4+: +40 Chillaxing XP / +40 Knowledge XP",
    ],
    "Getting the Look Right": [
      7,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Cosplay 1+, Cosplay 3+, Artsiness 2+, Posing 1+, Stink <0",
      "Stink 4+, Cool <1",
      "0: +5 GeoSense XP<br/>1: +10 GeoSense XP<br/>2: +20 GeoSense XP / +2 Cool<br/>3: +30 GeoSense XP / +3 Cool<br/>4+: +40 Glowsticking XP",
    ],
    "How to Draw Ninjas": [
      5,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Cool 1+, Photography 1+, Artsiness 1+, Artsiness 2+, Monies 5+",
      "Stink 4+, Cool <1",
      "0: +5 Artsiness XP / -1 Cool<br/>1: +5 Artsiness XP<br/>2: +20 Artsiness XP<br/>3: +50 Artsiness XP / +2 Cool<br/>4+: +80 Macking XP / +3 Cool / 1 +25% Event Find on Regular Mission Award",
    ],
    ...
    "Ninja Speed Dating": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <0, Stink <-2, Macking 1+, Macking 2+, Chillaxing 1+",
      "Stink 4+, Cool <1",
      "0: +5 Macking XP<br/>1: +10 Macking XP<br/>2: +20 Macking XP / +3 Cool<br/>3: +40 Macking XP / +3 Cool<br/>4+: +40 Antidrama XP",
    ],
    "Missions and You": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <1, Nom 4+, Knowledge 2+, GeoSense 1+, Drama 3+",
      "Stink 4+, Cool <1",
      "0: +5 Knowledge XP<br/>1: +10 Knowledge XP<br/>2: +20 Knowledge XP / +3 Cool<br/>3: +40 Knowledge XP<br/>4+: 1 +50 Stamina Award",
    ],
    ...
    "Robots are Awesome": [
      6,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Cool 6+, Artsiness 2+, Shopping 2+, Knowledge 2+, Artsiness 4+",
      "Stink 4+, Cool <1",
      "0: +5 Knowledge XP<br/>1: +10 Knowledge XP<br/>2: +20 Knowledge XP<br/>3: +40 Knowledge XP<br/>4+: +40 Combat Sewing XP",
    ],
    "Sports For Ninjas": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Sleep 3+, Combat Sewing 1+, Dance 2+, Cosplay 1+, Nom 4+",
      "Stink 4+, Cool <1",
      "0: +10 Dance XP<br/>1: +20 Dance XP<br/>2: +30 Dance XP<br/>3: +30 Dance XP / +1 Cool<br/>4+: +30 Dance XP / +30 Glowsticking XP",
    ],
    "TACOS and You": [
      6,
      "-4 Nom, -3 Sleep, +2 Stink",
      "Stink <1, Shopping 1+, Shopping 3+, Nom 5+, Knowledge 2+",
      "Stink 4+, Cool <1",
      "0: +20 Chillaxing XP<br/>1: +30 Chillaxing XP<br/>2: +40 Chillaxing XP / +2 Nom<br/>3: +40 Chillaxing XP / +4 Nom<br/>4+: +60 Macking XP",
    ],
    ...
    "The Loop Conspiracy": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <3, GeoSense 1+, Sleep 3+, Nom 3+, Knowledge 3+",
      "Stink 4+, Cool <1",
      "0: +5 Knowledge XP<br/>1: +10 Knowledge XP<br/>2: +20 Knowledge XP<br/>3: +30 Knowledge XP<br/>4+: +50 Knowledge XP",
    ],
    "Village Meetup": [
      6,
      "-3 Nom, -3 Sleep, +3 Stink",
      "Stink <1, Wrangling 1+, Cool 4+, Knowledge 1+, Nom 2+",
      "Stink 4+, Cool <1",
      "0: +15 Chillaxing XP<br/>1: +25 Chillaxing XP<br/>2: +50 Chillaxing XP / +2 Cool<br/>3: +40 Schmoozing XP / +3 Cool<br/>4+: +40 Schmoozing XP / +4 Cool",
    ],
    "What Not To Buy": [
      6,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Monies 4+, Stink <4, Shopping 1+, Shopping 2+, Knowledge 1+",
      "Stink 4+, Cool <1",
      "0: +10 Shopping XP<br/>1: +20 Shopping XP<br/>2: +30 Shopping XP<br/>3: +40 Shopping XP / +2 Monies<br/>4+: +40 Shopping XP / +4 Monies",
    ],
    "What's for Lunch": [
      5,
      "-1 Nom, +3 Sleep, +2 Stink",
      "Shopping 1+, Shopping 2+, Nom 3+, Nom 5+, Monies 2+",
      "Stink 4+, Cool <1",
      "0: +10 Knowledge XP<br/>1: +20 Knowledge XP / +3 Nom<br/>2: +20 Knowledge XP / +4 Nom<br/>3: +30 Dance XP / +1 Cool<br/>4+: +30 Shopping XP / +30 Chillaxing XP / +4 Nom",
    ],
    "When Is Houses Coming Out?": [
      5,
      "-2 Nom, -2 Sleep, +2 Stink",
      "Stink <1, Knowledge 1+, Chillaxing 2+, Antidrama 2+, Schmoozing 1+",
      "Stink 4+, Cool <1",
      "0: +5 Drama XP / -2 Cool<br/>1: +20 Drama XP / -1 Cool<br/>2: +40 Drama XP / -1 Cool<br/>3: +40 Drama XP<br/>4+: +40 Antidrama XP",
    ],
    ...
    "You and Your Kunai": [
      5,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Cool 4+, Cool 8+, Artsiness 3+, Veteran 1+, Antidrama 1+",
      "Stink 4+, Cool <1",
      "0: +5 Dance XP<br/>1: +10 Videogame XP<br/>2: +20 Combat Sewing XP<br/>3: +40 Combat Sewing XP<br/>4+: +60 Combat Sewing XP / +30 Glowsticking XP",
    ],
    // All night events
    ...
    "Staring at People": [
      5,
      "-1 Nom",
      "Stink <0, Silence 1+, GeoSense 1+, Photography 2+, Crowdswimming 1+",
      "Stink 4+, Cool <1",
      "0: +10 Silence XP<br/>1: +30 Silence XP<br/>2: +50 Silence XP / +40 Photography XP<br/>3: +60 Silence XP / +40 Photography XP<br/>4+: +80 Silence XP / +50 Photography XP",
    ],
    ...
    "Charity Auction": [
      7,
      "-1 Nom, -1 Sleep, +1 Stink, -2 Monies",
      "Crowdswimming 3+, Shopping 1+, Shopping 4+, Knowledge 3+",
      "Stink 4+, Cool <1",
      "0: +10 Shopping XP<br/>3: +80 Shopping XP<br/>4+: +80 Shopping XP / 1 +25% Ryo on Regular Missions Award",
    ],
    ...
    "Cute Cat Pictures": [
      7,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <1, Chillaxing 1+, Artsiness 2+, Wrangling 2+, Nom 5+",
      "Stink 4+, Cool <1",
      "0: +1 Pet Point<br/>3: +40 Staring XP / +60 Photography XP / +1 Pet Point<br/>4+: +80 Chillaxing XP / +80 Flipping Out XP / +2 Pet Points",
    ],
    ...
    "Highschool Girls on Guitar": [
      7,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <1, Dance 1+, Glowsticking 1+, Crowdswimming 1+, Chillaxing 3+",
      "Stink 4+, Cool <1",
      "0: +5 Artsiness XP<br/>3: +80 Artsiness XP<br/>4+: +80 Crowdswimming XP / 1 +25% Event Find on Regular Missions Award",
    ],
    ...
    "It's Only Cheese if you Lose": [
      7,
      "-2 Nom, -1 Sleep, +1 Stink",
      "Stink <1, Chillaxing 1+, Videogaming 1+, Videogaming 3+, Sleep 4+, Antidrama 1+",
      "Stink 4+, Cool <1",
      "0: -2 Cool<br/>3: +80 Videogaming XP<br/>4+: +80 Videogaming XP / +2 Cool / 1 +25% Bits/Core Award",
    ],
    ...
    "People With Blogs": [
      7,
      "-2 Nom, -1 Sleep, +1 Stink",
      "Stink <1, Chillaxing 3+, Drama 5+, Wrangling 2+, Videogaming 3+",
      "Stink 4+, Cool <1",
      "0: -2 Cool<br/>3: +40 Knowledge XP / +40 Artsiness XP<br/>4+: +60 Posing XP / +60 Antidrama XP / 1 +5% Party House Discount Award",
    ],
    "Talking About Cool Stuffs": [
      7,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <-1, Chillaxing 2+, Cool 10+, Schmoozing 1+, Knowledge 4+",
      "Stink 4+, Cool <1",
      "0: +10 Chillaxing XP<br/>3: +80 Chillaxing XP<br/>4+: +80 Chillaxing XP / +40 Veteran XP / 1 20 Appetite Award",
    ],
    ...
    "Way More Than 150": [
      7,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Stink <3, Chillaxing 1+, Chillaxing 2+, GeoSense 1+, Veteran 3+",
      "Stink 4+, Cool <1",
      "0: +10 Videogaming XP<br/>3: +40 Videogaming XP / +60 Photography XP<br/>4+: +80 Videogaming XP / +80 Photography XP / 1 +50 Stamina Award",
    ],
    ...
    // All night events
    "Falling Asleep at the Con": [
      7,
      "-1 Nom",
      "Stink <1, Chillaxing 1+, Chillaxing 3+, Silence 1+, Veteran 1+",
      "Stink 4+, Cool <1",
      "0: +3 Stink / +3 Sleep<br/>3: +1 Stink / +5 Sleep / +50 Wrangling XP<br/>4+: +1 Stink / +7 Sleep / +80 Macking XP / +80 Chillaxing XP",
    ],
    ...
    "Advanced Cosplay": [
      7,
      "-2 Nom, -2 Sleep, +2 Stink",
      "Photography 3+, Cosplay 2+, Combat Sewing 3+, Knowledge 3+, Cool 6+",
      "Cosplay <1, Cosplay <2, Cool <3, Stink 2+, Photography <2",
      "0: -1 Cool<br/>3+: +100 Cosplay XP / +60 Combat Sewing XP / 1 +5% Party House Discount Award",
    ],
    "Advanced Lulz": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Flipping Out 3+, Chillaxing 2+, Artsiness 3+, GeoSense 3+, Monies 8+",
      "Flipping Out <1, Flipping Out <2, Cool <3, Stink 2+, Chillaxing <2",
      "0: -1 Cool<br/>3+: +120 Drama XP / +120 Crowdswimming XP / 1 +100 Stamina Award",
    ],
    "Ancient History": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Knowledge 3+, GeoSense 2+, Veteran 3+, Antidrama 3+, Sleep 6+",
      "Knowledge <1, Knowledge <2, Cool <3, Stink 2+, Veteran <2",
      "0: -1 Cool<br/>3+: +100 Knowledge XP / +100 GeoSense XP / 1 +1 Drop on MegaMissions Award",
    ],
    "Bawwing for Fun and Profit": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Drama 3+, Drama 4+, Flipping Out 3+, Cool 6+",
      "Drama <1, Drama <2, Cool <3, Stink 2+, Antidrama <2",
      "0: -1 Cool<br/>3+: +100 Schmoozing XP / +100 Wrangling XP / 1 +25% Event Find on Regular Missions Award",
    ],
    "Cats - Nature's Ninjas": [
      7,
      "-3 Nom, -3 Sleep, +2 Stink",
      "Dance 3+, Drama 2+, Antidrama 3+, Wrangling 3+, Cool 6+",
      "Silence <1, Silence <2, Cool <3, Stink 2+, GeoSense <2",
      "0: +1 Pet Point<br/>3+: +100 Silence XP / +50 Flipping Out XP / 1 +25% Event Find on Regular Missions Award / +2 Pet Points",
    ],
    ...
    "Hiding in Plain Sight": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Photography 3+, GeoSense 2+, Silence 3+, Macking 3+, Sleep 5+",
      "Silence <1, Silence <2, Cool <3, Stink 2+, Sleep <3",
      "0: -1 Cool<br/>3+: +120 Silence XP / +80 Chillaxing XP / 1 +25% Bits/Core Award",
    ],
    "Jutsu Per Minute": [
      7,
      "-1 Nom, -1 Sleep, +3 Stink",
      "Photography 3+, Chillaxing 2+, Glowsticking 3+, Crowdswimming 3+, Cool 6+",
      "Dance <1, Dance <2, Cool <3, Stink 2+, Glowsticking <2",
      "0: -1 Cool<br/>3+: +70 Glowsticking XP / +70 Rocking XP / 1 +50 Stamina Award",
    ],
    ...
    "Ninja Detective Skills": [
      6,
      "-2 Nom, -1 Sleep, +2 Stink",
      "Photography 3+, Antidrama 2+, Wrangling 3+, Knowledge 3+, Cool 6+",
      "Knowledge <1, Knowledge <2, Cool <3, Stink 2+, Cosplay <1",
      "0: -1 Cool<br/>3+: +120 Photography XP / 1 +1 Drop on MegaMissions Award",
    ],
    ...
    "Relaxing With The Rack": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Shopping 3+, Photography 2+, Videogaming 3+, Macking 3+, Cool 6+",
      "Chillaxing <1, Chillaxing <2, Cool <3, Stink 2+, Macking <2",
      "0: -1 Cool<br/>3+: +120 Chillaxing XP / +4 Cool / 1 +20 Appetite Award",
    ],
    ...
    "The Many Uses of Glowsticks": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Knowledge 3+, Photography 2+, Chillaxing 3+, Sleep 7+, Cool 6+",
      "Knowledge <1, Knowledge <2, Cool <3, Stink 2+, Cosplay <2",
      "0: -1 Cool<br/>3+: +100 Glowsticking XP / +100 Combat Sewing XP / 1 +5% Party House Discount Award",
    ],
    "The Music Within": [
      7,
      "-2 Nom, -2 Sleep, +1 Stink",
      "Glowsticking 3+, Knowledge 2+, Chillaxing 3+, Sleep 7+, Cool 6+",
      "Artsiness <1, Artsiness <2, Cool <3, Stink 2+, Rocking <2",
      "0: -1 Cool<br/>3+: +150 Artsiness XP / 1 25% Ryo on Regular Missions Award",
    ],
    "Use Your Crazy": [
      7,
      "-1 Nom, -1 Sleep, +1 Stink",
      "Drama 3+, Flipping Out 3+, Flipping Out 4+, Macking 2+, Cool 6+",
      "Flipping Out <1, Flipping Out <2, Drama <2, Cool <3, Stink 2+",
      "0: -1 Cool<br/>3+: +100 Flipping Out XP / 1 +25% Event Find on Regular Missions Award",
    ],
    ...
    // Backstage 1
    "Bingoing Rulebreakers": [
      6,
      "-3 Nom, -5 Sleep, +4 Stink",
      "GeoSense 4+, Silence 4+, Cosplay 4+, Artsiness 4+, Glomping 1+",
      "Cool <10, Stink 2+, GeoSense <3, Silence <3, Cosplay <3",
      "0: -1 Cool<br/>2: +15 Reputation XP<br/>4+: +30 Reputation XP / +40 Sense Motive XP",
    ],
    "Bomb Disposal": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Cosplay 4+, Artsiness 4+, Veteran 4+, Drama 4+, The Angles 1+",
      "Cool <10, Stink 2+, Cosplay <3, Artsiness <3, Veteran <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Spot XP",
    ],
    "Bootleg Detection": [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Artsiness 4+, Veteran 4+, Drama 4+, Antidrama 4+, Glomping 1+",
      "Cool <10, Stink 2+, Artsiness <3, Veteran <3, Drama <3",
      "0: -1 Cool<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Sense Motive XP",
    ],
    Destankifying: [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Veteran 4+, Drama 4+, Antidrama 4+, Flipping Out 4+, The Angles 1+",
      "Cool <10, Stink 2+, Veteran <3, Drama <3, Antidrama <3",
      "0: -1 Cool<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Search XP",
    ],
    "Drama Exacerbation": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Flipping Out 4+, Knowledge 4+, Wrangling 4+, GeoSense 4+, Glomping 1+",
      "Cool <10, Stink 2+, Flipping Out <3, Knowledge <3, Wrangling <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Detect Traps XP",
    ],
    "Field Defense": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Antidrama 4+, Flipping Out 4+, Knowledge 4+, Wrangling 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Antidrama <3, Flipping Out <3, Knowledge <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Hide XP",
    ],
    "Food Testing": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Cosplay 4+, Wrangling 4+, GeoSense 4+, Silence 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Wrangling <3, GeoSense <3, Silence <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Bluff XP",
    ],
    "Guest  Management": [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Drama 4+, Antidrama 4+, Flipping Out 4+, Knowledge 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Drama <3, Antidrama <3, Flipping Out <3",
      "0: -1 Stink<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Spot XP",
    ],
    "Hotel Cleansing": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Veteran 4+, Drama 4+, Antidrama 4+, Flipping Out 4+, Glomping 1+",
      "Cool <10, Stink 2+, Veteran <3, Drama <3, Antidrama <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Detect Traps XP",
    ],
    "Hungry Spirit Exorcising": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Knowledge 4+, Wrangling 4+, GeoSense 4+, Silence 4+, The Angles 1+",
      "Cool <10, Stink 2+, Knowledge <3, Wrangling <3, GeoSense <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Bluff XP",
    ],
    "Monies Verification": [
      6,
      "-4 Nom, -6 Sleep, +4 Stink",
      "Cosplay 4+, Artsiness 4+, Veteran 4+, Drama 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Cosplay <3, Artsiness <3, Veteran <3",
      "0: -1 Cool<br/>2: +20 Reputation XP<br/>4+: +40 Reputation XP / +50 Search XP",
    ],
    "Line Management": [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Flipping Out 4+, Knowledge 4+, Wrangling 4+, GeoSense 4+, The Angles 1+",
      "Cool <10, Stink 2+, Flipping Out <3, Knowledge <3, Wrangling <3",
      "0: -1 Cool<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Detect Traps XP",
    ],
    "Pajama Bugging": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Drama 4+, Antidrama 4+, Flipping Out 4+, Knowledge 4+, The Angles 1+",
      "Cool <10, Stink 2+, Drama <3, Antidrama <3, Flipping Out <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Bluff XP",
    ],
    "Panelist Reanimation": [
      6,
      "-4 Nom, +4 Sleep, -3 Stink",
      "Staring 1+, Staring 2+, Staring 4+, Stink <-2, Sleep 6+",
      "Stink 3+, Staring <1",
      "0: -1 Cool / +3 Monies<br/>1: +4 Monies / +20 Staring XP<br/>2: +6 Monies / +30 Staring XP<br/>4+: +8 Monies / +30 Use Rope XP / 1 11% Chance for a Manly Apron Award",
    ],
    "Pizza Delivery": [
      6,
      "-3 Nom, -5 Sleep, +4 Stink",
      "Silence 4+, Cosplay 4+, Artsiness 4+, Veteran 4+, The Angles 1+",
      "Cool <10, Stink 2+, Silence <3, Cosplay <3, Artsiness <3",
      "0: -1 Cool<br/>2: +15 Reputation XP<br/>4+: +30 Reputation XP / +40 Spot XP",
    ],
    "Security Detail": [
      6,
      "-2 Nom, -3 Sleep, +3 Stink",
      "Artsiness 4+, Veteran 4+, Drama 4+, Antidrama 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Artsiness <3, Veteran <3, Drama <3",
      "0: -1 Cool<br/>2: +10 Reputation XP<br/>4+: +20 Reputation XP / +25 Hide XP",
    ],
    "Shoplifter Detection": [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Antidrama 4+, Flipping Out 4+, Knowledge 4+, Wrangling 4+, Glomping 1+",
      "Cool <10, Stink 2+, Antidrama <3, Flipping Out <3, Knowledge <3",
      "0: -1 Cool<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Hide XP",
    ],
    "Underground Dweller Hunting": [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Cosplay 4+, Artsiness 4+, Veteran 4+, Drama 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Cosplay <3, Artsiness <3, Veteran <3",
      "0: -1 Cool<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Use Rope XP",
    ],
    "Zombie Dispersal": [
      6,
      "-1 Nom, -2 Sleep, +2 Stink",
      "Knowledge 4+, Wrangling 4+, GeoSense 4+, Silence 4+, Crossplay 1+",
      "Cool <10, Stink 2+, Knowledge <3, Wrangling <3, GeoSense <3",
      "0: -1 Cool<br/>2: +5 Reputation XP<br/>4+: +10 Reputation XP / +10 Sense Motive XP",
    ],
  };
  ...
  var addEventToolTip = function (myCell, cssClass) {
    ...
    var boBDY =
      "<table class='conTable'><tr><td>Cost:</td><td>" +
      events[cellTitle][1] +
      "</td><tr><td>Bonuses (" +
      bonuses[0] +
      "):</td><td>" +
  ...
  var sortSkills = function () {
    ...
    if (!parsedSkills) {
      ...
      descriptions = descriptions
        .slice(22, descriptions.length - 39)
        .replace(/\([\d.k]+\/[\d.k]+\)/g, "")
        .split(/.<br>/);
    ...
    for (i = 0; i < skills.length; i++) {
      if (skills[i].length) {
        ...
        for (j = 0; j < skills[i].length; j++) {
          ...
          cell.innerHTML =
            '<div class="skillBack">' +
            '<div class="skillFront' +
            (settings.skillProgressBar ? "" : "NPB") +
            '" style="width:' +
            skills[i][j][2] +
            '%;"/>' +
            '<div class="skillText"><b>' +
            skills[i][j][0] +
            "</b></div>" +
          ...
          cell.firstChild.title =
            ...
            ")]" +
            "body=[" +
            (settings.skillDescription ? skills[i][j][3] + (skills[i][j][4].length ? "<br/><i>" + skills[i][j][4] + "</i>" : "") + "<br/><br/>" : "") +
            "<b>XP needed:</b> " +
            (skills[i][j][1][1] - skills[i][j][1][0]) +
            "]" +
            "thin=[1]";
          if (skillsDisabled) {
  ...
  var initSchedule = function () {
    ...
    statsDiv.innerHTML = "<table style='text-align: right'>" + "<tr><td>Sleep:</td><td/></tr>" + "<tr><td>Stink:</td><td/></tr>" + "<tr><td>Nom:</td><td/></tr>" + "<tr><td>Cool:</td><td/></tr>" + "<tr><td>Monies:</td><td/></tr>" + "</table>";
    div = document.createElement("div");
    ...
    var loadDivInnerHTML = "<b>Schedule State:</b><table>" + '<tr><td><input type="text" size=10/><button type="button">Save</button></td></tr>' + "<tr><td><select>";
...
/**    var i, j;
    ...
    if (form && /name="packit"/.test(form.innerHTML)) {
      ...
      for (i = 0; i < cosplayNames.length; i++) {
        ...
        row.innerHTML =
          ...
          (head ? (head[1] > 1 ? (head[1] > 2 ? "#FF0" : "#6FF") : "#9F9") : "#FC9") +
          '"' +
          (head && head[1] > 1 ? 'title="' + head[1] + '"' : "") +
          ">" +
          (head
            ? '<input type="checkbox" name="pack&' + head[2] + '" id ="cpp' + head[2] + '"><label for="cpp' + head[2] + '" title="Average: ' + getAverage(head[0], 0) + " | with BOX O' HEDZ: " + getAverage(head[0], 1) + '">' + head[0] + "</label>"
            : "") +
          "</td>" +
          '<td style="background-color: ' +
          (body ? (body[1] > 1 ? (body[1] > 2 ? "#FF0" : "#6FF") : "#9F9") : "#FC9") +
          '"' +
          (body && body[1] > 1 ? 'title="' + body[1] + '"' : "") +
          ">" +
          (body ? '<input type="checkbox" name="pack&' + body[2] + '" id ="cpp' + body[2] + '"><label for="cpp' + body[2] + '" title="Average: ' + getAverage(body[0], 0) + '">' + body[0] + "</label>" : "") +
          "</td>" +
          '<td style="background-color: ' +
          (prop ? (prop[1] > 1 ? (prop[1] > 2 ? "#FF0" : "#6FF") : "#9F9") : "#FC9") +
          '"' +
          (prop && prop[1] > 1 ? 'title="' + prop[1] + '"' : "") +
          ">" +
          (prop ? '<input type="checkbox" name="pack&' + prop[2] + '" id ="cpp' + prop[2] + '"><label for="cpp' + prop[2] + '" title="Average: ' + getAverage(prop[0], 0) + '">' + prop[0] + "</label>" : "") +
          "</td>" +
          '<td title="' +
          (cosplay["Full"] === undefined ? "" : "Average: " + getAverage(cosplay["Full"], 0)) +
          '">' +
          (cosplay["Full"] === undefined ? "" : cosplay["Full"]) +
          "</td>";
      }
  ...
  return {
    init: function () {
      var i;
      for (i = 1; i < 10; i++) factorial[i] = factorial[i - 1] * i;
